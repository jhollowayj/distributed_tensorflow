...
parser.add_argument('--grad_update_cnt_before_send', '-send', default=1,  type=int, required=False, help="")
...
parser.add_argument('--ckpt_save_interval', '-save', default=3,  type=int, required=False, help="")
