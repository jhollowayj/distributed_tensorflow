...
class JacobsMazeWorld():
    ...
    def buildMaze(self):
        return {
            0: self.buildMaze_staggered,
            1: self.buildMaze_orgMaze,
            2: self.buildMaze_circles,
    ...
    #######################################################################
    def start(self): # allocate gpu if needed, etc.
        return
    ...
    def buildMaze_circles(self):
        w, o, c = maze_object.wall, maze_object.open, maze_object.coin
        return np.array([
            [w,w,w,w,w,w,w,w,w,w,w,w],  # [w w w w w w w w w w w w]
            [w,c,c,c,c,c,c,c,c,c,c,w],  # [w                     w]
            [w,c,w,w,c,w,w,w,w,w,c,w],  # [w   w w   w w w w w   w]
            [w,c,w,c,c,c,c,c,c,w,c,w],  # [w   w             w   w]
            [w,c,w,c,w,w,c,w,c,c,c,w],  # [w   w   w w   w       w]
            [w,c,w,c,w,c,c,w,c,w,c,w],  # [w   w   w     w   w   w]
            [w,c,w,c,w,c,c,w,c,w,c,w],  # [w   w   w     w   w   w]
            [w,c,c,c,w,c,w,w,c,w,c,w],  # [w       w   w w   w   w]
            [w,c,w,c,c,c,c,c,c,w,c,w],  # [w   w             w   w]
            [w,c,w,w,w,w,w,c,w,w,c,w],  # [w   w w w w w   w w   w]
            [w,c,c,c,c,c,c,c,c,c,c,w],  # [w                     w]
            [w,w,w,w,w,w,w,w,w,w,w,w]   # [w w w w w w w w w w w w]
        ])
        maze[self.endLocation[0], self.endLocation[1]] = maze_object.exit
